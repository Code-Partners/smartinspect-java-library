...
//   connections string.
// </summary>
// <seealso cref="com.gurock.smartinspect.connections.options.OptionsParserListener"/>
// <remarks>
//   This class offers a single method only, called parse, which is
//   responsible for parsing the options part of a connections string.
//   This method informs the caller about found options with a supplied
//   callback listener.
// </remarks>
// <threadsafety>
...
public class OptionsParser
{
	...
	//   -                        -
	//   NullPointerException     The protocol, options or callback
	//                              argument is null.
